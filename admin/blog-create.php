...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$team_member_id) {
        ...
        try {
            global $db;
            $stmt = $db->prepare("INSERT INTO team_blog (team_member_id, title, content, excerpt, image_url, category, featured) VALUES (?, ?, ?, ?, ?, ?, ?)");
            $stmt->bind_param("isssssi", $team_member_id, $title, $content, $excerpt, $image_url, $category, $featured);
            $stmt->execute();
...
<head>
    ...
    <title>Add Blog Post - PixelTest Team Admin</title>
            ...
            <div class="admin-content">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="content" name="content" rows="8" required placeholder="Enter post content"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="excerpt">Excerpt (optional)</label>
                        <textarea id="excerpt" name="excerpt" rows="3" placeholder="Enter post excerpt (will be auto-generated if empty)"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="image_url">Image URL</label>
                        <input type="url" id="image_url" name="image_url" placeholder="Enter post image URL">
                    </div>
