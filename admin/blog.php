...
<head>
    ...
    <title>Blog - PixelTest Team Admin</title>
        ...
        <main class="admin-main">
            <header class="admin-header">
                ...
                <div class="admin-header-actions">
                    <a href="blog-create.php" class="btn-primary">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <?php foreach ($blogPosts as $post): ?>
                                    <tr>
                                        <td>
                                            <img src="<?php echo htmlspecialchars($post['image_url'] ?? 'https://via.placeholder.com/50'); ?>"
                                                 alt="<?php echo htmlspecialchars($post['title']); ?>"
                                                 class="table-avatar">
                                        </td>
                                        <td><?php echo htmlspecialchars($post['title']); ?></td>
                                        <td><?php echo htmlspecialchars($post['member_name']); ?></td>
                                        <td>
                                            <span class="badge badge-<?php echo htmlspecialchars($post['category']); ?>">
                                        ...
                                        <td class="table-actions">
                                            <a href="blog-edit.php?id=<?php echo $post['id']; ?>" class="action-btn edit-btn">
                                                <ion-icon name="create-outline"></ion-icon>
                                                Edit
                                            </a>
                                            <form method="POST" action="" onsubmit="return confirm('Are you sure you want to delete this blog post?');">
